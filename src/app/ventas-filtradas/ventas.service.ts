...
export class VentasService {
  public produccion = 'https://dazzling-spontaneity-production.up.railway.app/api/ventas';
  public testing = 'http://localhost:8080/api/ventas';
  private baseUrl = this.testing;
